...
const RecentAlerts = () => {
  ...
  const [investigatingVuln, setInvestigatingVuln] = useState<Vulnerability | null>(null);
  ...
  const handleInvestigate = (vuln: Vulnerability) => {
    console.log('🔍 Opening investigation for:', vuln.id);
    setInvestigatingVuln(vuln);
  };
  ...
  return (
    <>
      ...
      <InvestigationReportModal 
        vulnerability={investigatingVuln}
        onClose={() => setInvestigatingVuln(null)}
      />
    </>
  );
};
